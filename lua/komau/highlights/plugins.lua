...
local function telescope(colors)
    ...
    t.TelescopePreviewMatching = { fg = colors.accent }
    ...
    t.TelescopeMatching = { fg = colors.accent }
    return t
end
...
local function neotree(colors)
    local n = {}
    n.NeoTreeNormal = { fg = colors.norm, bg = colors.bg_very_very_subtle }
    n.NeoTreeNormalNC = { fg = colors.norm, bg = colors.bg_very_very_subtle }
    n.NeoTreeSignColumn = { fg = colors.norm, bg = colors.bg_very_very_subtle }
    n.NeoTreeEndOfBuffer = { fg = colors.bg_very_very_subtle, bg = colors.bg_very_very_subtle }
    ...
    -- n.NeoTreeVertSplit = { bg = colors.accent } -- |hl-VertSplit| override in Neo-tree window.
    n.NeoTreeWinSeparator = { fg = colors.bg, bg = colors.bg } -- |hl-WinSeparator| override in Neo-tree window.
