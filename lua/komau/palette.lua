...
local base = {
    ...
    medium_gray = { gui = "#868686", cterm = 243 },
    white = { gui = "#e9e0d5", cterm = 255 },
    white_warm = { gui = "#dad3c1", cterm = 255 },
    light_black = { gui = "#424242", cterm = 238 },
    lighter_black = { gui = "#545454", cterm = 240 },
    subtle_black = { gui = "#303030", cterm = 236 },
    subtler_black = { gui = "#262626", cterm = 237 },
    light_gray = { gui = "#c9bfb3", cterm = 246 },
    lighter_gray = { gui = "#d9cfc5", cterm = 252 },
    lightest_gray = { gui = "#f1eae3", cterm = 254 },
    yellow = { gui = "#e9c46a", cterm = 221 },
    pink = { gui = "#d3774b", cterm = 209 },
    green = { gui = "#40916c", cterm = 29 },
    red = { gui = "#bc4749", cterm = 124 },
    orange = { gui = "#e76f51", cterm = 166 },
    blue = { gui = "#468faf", cterm = 26 },
    purple = { gui = "#6d597a", cterm = 96 },
}
...
local variants = {
    dark = function()
        return {
            ...
            bg_very_very_subtle = base.subtler_black,
